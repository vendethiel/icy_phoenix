...
if ( $board_config['rabbitoshi_enable'] && $searchid == $user_id ) 
{
	...
	for($k = 0; $k < $number_items ; $k++)
	{
		...
		if(file_exists(IP_ROOT_PATH."rabbitoshi/images/items/".$rabbitoshi_shop[$k]['item_img'].""))
		{ $pic = '<img src="'.IP_ROOT_PATH.'rabbitoshi/images/items/'.$rabbitoshi_shop[$k]['item_img'].'">'; }
		else { $pic = ''; }
