					...
					<tr>
						...
						<td class="row2">
							<table class="forumline tw200px">
								<tr><td class="row2 tdnw" colspan="3"><img src="{BAR_GRAPHIC_LEFT}" width="4" height="12" alt="" /><img src="{BAR_GRAPHIC_BODY}" width="{UPLOAD_LIMIT_IMG_WIDTH}" height="12" alt="{INBOX_LIMIT_PERCENT}" /><img src="{BAR_GRAPHIC_RIGHT}" width="4" height="12" alt="" /></td></tr>
								<tr>
