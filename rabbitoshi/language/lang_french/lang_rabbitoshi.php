...
$lang['Rabbitoshi_nopet_lack']='Vous n\'avez pas suffisamment de points pour avoir une créature.';
...
$lang['Rabbitoshi_hidden']='Désolé , cet utilisateur souhaite garder secrètes les caractéristiques de sa créature<br /><br /> Cliquez <a href="'.append_sid("index.PHP_EXT").'">ici</a> pour retourner à l\'index du forum';
...
$lang['Rabbitoshi_return']='<br /><br /> Cliquez <a href="'.append_sid("rabbitoshi.PHP_EXT").'">ici</a> pour en acheter une autre<br /><br /> Cliquez <a href="'.append_sid("index.PHP_EXT").'">ici</a> pour retourner à l\'index du forum';
...
$lang['Rabbitoshi_pet_dead_rebirth_no']='Votre créature est morte, revenez quand vous serez prêt à la réssuciter.<br /><br />Cliquez <a href="'.append_sid("adr_zones.PHP_EXT").'">ici</a> pour retourner au RPG<br /><br /> Cliquez <a href="'.append_sid("index.PHP_EXT").'">ici</a> pour retourner à l\'index du forum';
//Vous avez laissé mourrir votre créature .
$lang['Rabbitoshi_pet_dead_rebirth_ok']='Votre créature a ressucité !<br /><br /> Cliquez <a href="'.append_sid("rabbitoshi.PHP_EXT").'">ici</a> pour retourner vous en occuper<br /><br /> Cliquez <a href="'.append_sid("index.PHP_EXT").'">ici</a> pour retourner à l\'index du forum';
...
$lang['Rabbitoshi_progress_experiencelimit_lack']='Votre créature n\'a pas le niveau requis pour augmenter de niveau.<br /><br />Cliquez <a href="'.append_sid("rabbitoshi.PHP_EXT").'">ici</a> pour retournez à la page de votre créature.';
...
$lang['Rabbitoshi_ability_price_lack']='Votre créature n\'a pas assez d\'expérience pour apprendre cette capacité<br /><br />Cliquez <a href="'.append_sid("rabbitoshi_progress.PHP_EXT").'">ici</a> pour revenir sur la page de progression de votre créature.';
$lang['Rabbitoshi_ability_stats_lack']='Les statistiques de votre créature ne sont pas suffisamment élevées pour apprendre cette capacité<br /><br />Cliquez <a href="'.append_sid("rabbitoshi_progress.PHP_EXT").'">ici</a> pour revenir sur la page de progression de votre créature.';
...
$lang['Rabbitoshi_general_return'] ='<br /><br /> Cliquez <a href="'.append_sid("rabbitoshi.PHP_EXT").'">ici</a> pour voir votre créature<br /><br /> Cliquez <a href="'.append_sid("rabbitoshi_shop.PHP_EXT").'">ici</a> pour acheter des articles pour votre créature<br /><br /> Cliquez <a href="'.append_sid("index.PHP_EXT").'">ici</a> pour retourner au Forum';
...
$lang['Rabbitoshi_admin_general_return']='<br /><br /> Cliquez <a href="'.append_sid("admin_rabbitoshi_owners.PHP_EXT").'">ici</a> pour retourner sur la page précédente<br /><br />';
