...
if( !file_exists(IP_ROOT_PATH . 'rabbitoshi/language/lang_' . $board_config['default_lang'] . '/lang_rabbitoshi.' . PHP_EXT)) {
	$board_config['default_lang'] = 'english';
}
include_once(IP_ROOT_PATH . 'rabbitoshi/language/lang_' . $board_config['default_lang'] . '/lang_rabbitoshi.' . PHP_EXT);
...
function rabbitoshi_previous( $lang_key , $direct , $nav='' )
{
	...
	$temp = ( !$nav ) ? $direct.'.'.PHP_EXT : $direct.'.'.PHP_EXT.'?'.$nav;
