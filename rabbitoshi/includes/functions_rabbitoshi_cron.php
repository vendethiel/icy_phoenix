...
if ( !defined('IN_RABBITOSHI') ) {
	include(IP_ROOT_PATH . 'rabbitoshi/includes/functions_rabbitoshi.'.PHP_EXT);
}
include(IP_ROOT_PATH . 'rabbitoshi/language/lang_' . $board_config['default_lang'] . '/lang_rabbitoshi.'.PHP_EXT);
