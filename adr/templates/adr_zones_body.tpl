...
<table width="100%" align="center" border="1">
	...
	<tr>
		...
		<table width="100%" align="center" border="1">
			<tr>
				<th align="center" colspan="4">{L_ADR_WORLDMAP}</th>
			</tr>
			<tr>
	    ...
	    <td align="center" valign="top" class="row1">
        	...
        	<img src="adr/images/TownMap/{SAISON}/Tuile_1_1.gif" style="height: 103px;" /><!-- IF HAS_PRISON --><a href="{U_TOWNMAP_PRISON}"><img src="adr/images/TownMap/{SAISON}/Tuile_1_2.gif" border="0" alt="{L_TOWNMAP_PRISON}" title="{L_Adr_zone_goto_prison}" /></a><!-- ELSE --><img src="adr/images/TownMap/{SAISON}/Tuile_empty_downwalled.png" style="width: 84px; height: 103px" title="{L_Adr_zone_goto_prison} ({L_BUILDING_UNAV})" /><!-- ENDIF --><img src="adr/images/TownMap/{SAISON}/Tuile_1_3.gif" style="height: 103px; max-width: 242px;" /><!-- IF HAS_BANK --><a href="{U_TOWNMAP_BANQUE}"><img src="adr/images/TownMap/{SAISON}/Tuile_1_4.gif" border="0" alt="{L_TOWNMAP_BANQUE}" title="{L_Adr_zone_goto_bank}" /></a><!-- ELSE --><img src="adr/images/TownMap/{SAISON}/Tuile_empty.png" style="width: 107px; height: 103px" border="0" alt="{L_TOWNMAP_BANQUE}" title="{L_Adr_zone_goto_bank} ({L_BUILDING_UNAV})" /><!-- ENDIF --><img src="adr/images/TownMap/{SAISON}/Tuile_1_5.gif" style="height: 103px;" /><!-- IF HAS_MINE --><a href="{U_TOWNMAP_MINE}"><img src="adr/images/TownMap/{SAISON}/Tuile_1_6.gif" border="0" alt="{L_TOWNMAP_MINE}" title="{L_Adr_zone_goto_mine}" /></a><!-- ELSE --><img src="adr/images/TownMap/{SAISON}/Tuile_empty.png" style="width: 92px; height: 103px" border="0" title="{L_Adr_zone_goto_mine} ({L_BUILDING_UNAV})" alt="{L_TOWNMAP_MINE}" /><!-- ENDIF --><img src="adr/images/TownMap/{SAISON}/Tuile_1_7.gif" style="height: 103px;" /><br />

        	<img src="adr/images/TownMap/{SAISON}/Tuile_Milieu.gif" class="tile_{SAISON}_milieu" /><br />

        	<img src="adr/images/TownMap/{SAISON}/Tuile_2_1.gif" style="height: 89px;" /><!-- IF HAS_ENCHANT --><a href="{U_TOWNMAP_ENCHANTEMENT}"><img src="adr/images/TownMap/{SAISON}/Tuile_2_2.gif" border="0" alt="{L_TOWNMAP_ENCHANTEMENT}" title="{L_Adr_zone_goto_pr}" /></a><!-- ELSE --><img src="adr/images/TownMap/{SAISON}/Tuile_empty.png" style="width: 55px; height: 89px;" border="0" alt="{L_TOWNMAP_ENCHANTEMENT}" title="{L_Adr_zone_goto_pr} ({L_BUILDING_UNAV})" /><!-- ENDIF --><img src="adr/images/TownMap/{SAISON}/Tuile_2_3.gif" style="height: 89px;" /><!-- IF HAS_TEMPLE --><a href="{U_TOWNMAP_TEMPLE}"><img title="{L_Adr_zone_goto_temple}" src="adr/images/TownMap/{SAISON}/Tuile_2_4.gif" border="0" alt="{L_TOWNMAP_TEMPLE}" /></a><!-- ELSE --><img src="adr/images/TownMap/{SAISON}/Tuile_empty.png" style="width: 87px; height: 89px;" border="0" title="{L_Adr_zone_goto_temple} ({L_BUILDING_UNAV})" /><!-- ENDIF --><img src="adr/images/TownMap/{SAISON}/Tuile_2_5.gif" style="height: 89px;" /><!-- IF HAS_SHOPS --><a href="{U_TOWNMAP_BOUTIQUE}"><img src="adr/images/TownMap/{SAISON}/Tuile_2_6.gif" border="0" title="{L_Adr_zone_goto_shops}" alt="{L_TOWNMAP_BOUTIQUE}" /></a><!-- ELSE --><img src="adr/images/TownMap/{SAISON}/Tuile_empty.png" style="width: 89px; height: 89px;" border="0" title="{L_Adr_zone_goto_shops} ({L_BUILDING_UNAV})" /><!-- ENDIF --><img src="adr/images/TownMap/{SAISON}/Tuile_2_7.gif" class="tile_{SAISON}_27" style="height: 89px;" /><a href="{U_TOWNMAP_MAISON}"><img title="{Adr_zone_goto_house}" src="adr/images/TownMap/{SAISON}/Tuile_2_8.gif" style="height: 89px;" border="0" alt="{L_TOWNMAP_MAISON}" /></a><img src="adr/images/TownMap/{SAISON}/Tuile_2_9.gif" style="height: 89px;" /><br />

        	<img src="adr/images/TownMap/{SAISON}/Tuile_Bas.gif" class="tile_{SAISON}_Bas" /><br />

        	<img src="adr/images/TownMap/{SAISON}/Tuile_3_1.gif"/><!-- IF HAS_FORGE --><a href="{U_TOWNMAP_FORGE}"><img src="adr/images/TownMap/{SAISON}/Tuile_3_2.gif" border="0" alt="{L_TOWNMAP_FORGE}" title="{L_Adr_zone_goto_forge}" /></a><!-- ELSE --><img src="adr/images/TownMap/{SAISON}/Tuile_forge_empty.gif" border="0" alt="{L_TOWNMAP_FORGE}" title="{L_Adr_zone_goto_forge} ({L_BUILDING_UNAV})" /><!-- ENDIF --><img src="adr/images/TownMap/{SAISON}/Tuile_3_3.gif"/><a href="{U_SHAME}"><img title="{L_ADR_GUARD_TOWER}" src="adr/images/TownMap/{SAISON}/Tuile_3_4.gif" border="0" alt="{L_TOWNMAP_ENTRAINEMENT}" /></a><img src="adr/images/TownMap/{SAISON}/Tuile_3_5.gif" class="tile_{SAISON}_35" border="0" alt="{L_TOWNMAP_COMBAT}" /><!--<a href="{U_TOWNMAP_ENTREPOT}"><img title="Entrepôt" src="adr/images/TownMap/{SAISON}/Tuile_3_6.gif" border="0" alt="{L_TOWNMAP_ENTREPOT}" /></a>--><a href="{U_ZONE_BARRACK}"><img title="{L_ADR_TOWER}" src="adr/images/TownMap/{SAISON}/Tuile_3_6.gif" border="0" /></a><img src="adr/images/TownMap/{SAISON}/Tuile_3_7.gif" /><a href="{U_TOWNMAP_CLAN}"><img title="Taverne des guildes" src="adr/images/TownMap/{SAISON}/Tuile_3_8.gif" border="0" alt="{L_TOWNMAP_CLAN}" /></a><img src="adr/images/TownMap/{SAISON}/Tuile_3_9.gif" class="tile_{SAISON}_39" /><br />
        	<!-- IF HAS_MONSTERS -->
...
<table width="100%" align="center" border="1">
	<tr>
		<th align="center" colspan="10">{L_ACTIONS}</td>
	</tr>
	<tr>
        <td <!-- IF ! ZONE_BLACKSMITH -->class="disabled"<!-- ENDIF --> align="center" class="row1"><!-- IF ZONE_BLACKSMITH --><a href="adr_blacksmithing.php"><!-- ENDIF -->{L_Adr_blacksmithing}<!-- IF ZONE_BLACKSMITH --></a><!-- ENDIF --></td>
        <td <!-- IF ! ZONE_BREWING -->class="disabled"<!-- ENDIF --> align="center" class="row2"><!-- IF ZONE_BREWING --><a href="adr_brewing.php">{L_Adr_brewing}</a><!-- ENDIF --></td>
        <td <!-- IF ! ZONE_COOKING -->class="disabled"<!-- ENDIF --> align="center" class="row1"><!-- IF ZONE_COOKING --><a href="adr_cooking.php"><!-- ENDIF -->{L_Adr_cooking}<!-- IF ZONE_COOKING --></a><!-- ENDIF --></td>
    ...
    <tr>
	    <td <!-- IF ! ZONE_ALCHEMY -->class="disabled"<!-- ENDIF --> align="center" class="row2"><!-- IF ZONE_ALCHEMY --><a href="adr_alchemy.php"><!-- ENDIF -->{L_Adr_alchemy}<!-- IF ZONE_ALCHEMY --></a><!-- ENDIF --></td>
        <td <!-- IF ! ZONE_TAILOR -->class="disabled"<!-- ENDIF --> align="center" class="row1"><!-- IF ZONE_TAILOR --><a href="adr_tailor.php"><!-- ENDIF -->{L_ADR_ALCH}<!-- IF ZONE_TAILOR --></a><!-- ENDIF --></td>
    	<td <!-- IF ! ZONE_BEGGAR -->class="disabled"<!-- ENDIF --> align="center" class="row2"><!-- IF ZONE_BEGGAR --><a href="adr_beggar.php"><!-- ENDIF -->{L_ADR_TALK_TO_BEGGAR}<!-- IF ZONE_BEGGAR --></a><!-- ENDIF --></td>
    	<td <!-- IF ! ZONE_LAKE -->class="disabled"<!-- ENDIF --> align="center" class="row1"><!-- IF ZONE_LAKE --><a href="adr_lake.php"><!-- ENDIF -->{L_ADR_LAKE}<!-- IF ZONE_LAKE --></a><!-- ENDIF --></td>
    </td>
	<tr>
        <td <!-- IF ! ZONE_FISH -->class="disabled"<!-- ENDIF --> align="center" class="row1"><!-- IF ZONE_FISH --><a href="adr_fish.php"><!-- ENDIF -->{L_Adr_fishing}<!-- IF ZONE_FISH --></a><!-- ENDIF --></td>
        <td <!-- IF ! ZONE_HERBAL -->class="disabled"<!-- ENDIF --> align="center" class="row2"><!-- IF ZONE_HERBAL --><a href="adr_herbal.php"><!-- ENDIF -->{L_Adr_herbalism}<!-- IF ZONE_HERBAL --></a><!-- ENDIF --></td>
        <td <!-- IF ! ZONE_HUNTING -->class="disabled"<!-- ENDIF --> align="center" class="row1"><!-- IF ZONE_HUNTING --><a href="adr_hunting.php"><!-- ENDIF -->{L_Adr_hunting}<!-- IF ZONE_HUNTING --></a><!-- ENDIF --></td>
        <td <!-- IF ! ZONE_LUMBERJACK -->class="disabled"<!-- ENDIF --> align="center" class="row2"><!-- IF ZONE_LUMBERJACK --><a href="adr_lumberjack.php"><!-- ENDIF -->{L_Adr_lumberjack}<!-- IF ZONE_LUMBERJACK --></a><!-- ENDIF --></td>
    </tr>
</table>
<!-- ENDIF -->
<!-- END switch_Adr_zone_townmap_disable -->
