...
{
	global $db , $phpEx , $lang, $user_ip, $board_config , $userdata;
	...
	include_once(IP_ROOT_PATH . 'includes/functions_post.'.$phpEx);
	...
	{
		include_once(IP_ROOT_PATH . 'includes/functions_messages.'.$phpEx);
	...
	else
	{
		...
		if ( $to_userdata['user_notify_pm'] && !empty($to_userdata['user_email']) && $to_userdata['user_active'] )
		{
			...
			include_once(IP_ROOT_PATH . './includes/emailer.'.$phpEx);
