...
{
	$dest_zone = ( isset($_POST['zone']) ) ? htmlspecialchars($_POST['zone']) : htmlspecialchars($_GET['zone']);
}
else
{
	$dest_zone = $teleport_zone;
}
if ( isset($_GET['teleport']) || isset($_POST['teleport']) )
{
	$teleport = ( isset($_POST['teleport']) ) ? htmlspecialchars($_POST['teleport']) : htmlspecialchars($_GET['teleport']);
}
$teleported = $_POST['teleported'];
