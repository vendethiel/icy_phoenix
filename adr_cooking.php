...
if ( $mode != "" )
{
	switch($mode)
	{
		...
		case 'view':
			...
			$existing_recipe = ( isset($_POST['known_recipes']) ) ? trim($_POST['known_recipes']) : trim($_GETS['known_recipes']);
			...
			$existing_tool = ( isset($_POST['item_tool']) ) ? trim($_POST['item_tool']) : trim($_GETS['item_tool']);
