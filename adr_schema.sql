# ADR 0.4.4
ALTER TABLE ip_users ADD COLUMN user_adr_ban tinyint(1) default '0' NOT NULL;
ALTER TABLE ip_users ADD COLUMN user_cell_time INT(11) DEFAULT '0' NOT NULL;
ALTER TABLE ip_users ADD COLUMN user_cell_time_judgement INT(11) DEFAULT '0' NOT NULL;
ALTER TABLE ip_users ADD COLUMN user_cell_caution INT(8) DEFAULT '0' NOT NULL;
ALTER TABLE ip_users ADD COLUMN user_cell_sentence TEXT DEFAULT '';
ALTER TABLE ip_users ADD COLUMN user_cell_enable_caution INT(8) DEFAULT '0' NOT NULL;
ALTER TABLE ip_users ADD COLUMN user_cell_enable_free INT(8) DEFAULT '0' NOT NULL;
...
# ADR
#
CREATE TABLE ip_adr_alignments (
...
CREATE TABLE ip_adr_armour_sets (
...
CREATE TABLE ip_adr_battle_list (
...
CREATE TABLE ip_adr_battle_monsters (
...
CREATE TABLE ip_adr_battle_pvp (
  battle_id int(8) NOT NULL auto_increment,
...
CREATE TABLE ip_adr_beggar_donations (
...
CREATE TABLE ip_adr_beggar_tracker (
...
CREATE TABLE ip_adr_cauldron_pack (
...
CREATE TABLE ip_adr_characters (
...
CREATE TABLE ip_adr_create_exploit_fix (
...
CREATE TABLE ip_adr_jail_votes (
...
CREATE TABLE ip_adr_lake_donations (
  item_id int(8) NOT NULL default '0',
  item_chance tinyint(1) default NULL,
  item_owner_id tinyint(1) NOT NULL default '1',
  item_price int(8) NOT NULL default '0',
...
CREATE TABLE ip_adr_lake_tracker (
  track_id int(10) NOT NULL auto_increment,
  item_name varchar(100) default NULL,
  owner_name varchar(100) default NULL,
  donated int(12) default NULL,
...
CREATE TABLE ip_adr_shops_items (
...
CREATE TABLE ip_adr_shops_items_quality (
...
CREATE TABLE ip_adr_shops_items_type (
...
CREATE TABLE ip_adr_temple_donations (
  item_id int(8) NOT NULL default '0',
  item_chance tinyint(1) default NULL,
  item_owner_id tinyint(1) NOT NULL default '1',
  item_price int(8) NOT NULL default '0',
...
CREATE TABLE ip_adr_temple_tracker (
  track_id int(10) NOT NULL auto_increment,
  item_name varchar(100) default NULL,
  owner_name varchar(100) default NULL,
  donated int(12) default NULL,
...
CREATE TABLE ip_adr_vault_blacklist (
  user_id int(8) NOT NULL default '0',
  user_due int(8) NOT NULL default '0',
  PRIMARY KEY  (user_id)
) ;

CREATE TABLE ip_adr_vault_exchange (
...
CREATE TABLE ip_adr_vault_exchange_users (
...
CREATE TABLE ip_adr_vault_users (
...
CREATE TABLE ip_rabbitoshi_config (
...
CREATE TABLE ip_rabbitoshi_general (
  config_name varchar(255) NOT NULL default '0',
  config_value int(15) NOT NULL default '0',
  PRIMARY KEY  (config_name)
) ;

CREATE TABLE ip_rabbitoshi_shop (
...
CREATE TABLE ip_rabbitoshi_shop_users (
...
CREATE TABLE ip_rabbitoshi_users (
  owner_id int(8) NOT NULL default '0',
...
CREATE TABLE ip_adr_battle_community(
...
ALTER TABLE ip_adr_shops_items ADD item_stolen tinyint(1) NOT NULL default '0';
ALTER TABLE ip_adr_shops_items ADD item_steal_dc smallint(3) NOT NULL default '0';
ALTER TABLE ip_adr_shops ADD shop_last_updated int(12) NOT NULL default '0';

ALTER TABLE ip_adr_shops_items CHANGE `item_stolen` `item_stolen_id` INT(12) DEFAULT '0' NOT NULL;
ALTER TABLE ip_adr_shops_items CHANGE `item_steal_dc` `item_steal_dc` TINYINT(2) DEFAULT '2' NOT NULL;
ALTER TABLE ip_adr_shops_items ADD item_bought_timestamp int(12) NOT NULL default '0';

ALTER TABLE ip_adr_battle_list ADD battle_challenger_equipment_info varchar(255) NOT NULL default '';
ALTER TABLE ip_adr_battle_list ADD battle_round int(12) NOT NULL default '0';
ALTER TABLE ip_adr_battle_list ADD battle_start int(12) NOT NULL default '0';
ALTER TABLE ip_adr_battle_list ADD battle_finish int(12) NOT NULL default '0';

ALTER TABLE ip_adr_battle_pvp ADD battle_start int(12) NOT NULL default '0';
ALTER TABLE ip_adr_battle_pvp ADD battle_finish int(12) NOT NULL default '0';

ALTER TABLE ip_adr_elements ADD element_colour varchar(255) NOT NULL default '';

CREATE TABLE ip_adr_stores_stats(
...
CREATE TABLE ip_adr_stores_user_history(
...
# ADR 0.4.5
ALTER TABLE ip_adr_shops_items_type ADD item_type_order MEDIUMINT( 8 ) NOT NULL DEFAULT '1';
ALTER TABLE `ip_adr_shops_items_type` ADD `item_type_category` VARCHAR( 50 ) NOT NULL DEFAULT '';

# NPC System
CREATE TABLE `ip_adr_npc` (
...
ALTER TABLE `ip_adr_battle_monsters` DROP `monster_area`;
ALTER TABLE `ip_adr_battle_monsters` DROP `monster_area_name`;
ALTER TABLE `ip_adr_zones` ADD `zone_monsters_list` TEXT NOT NULL;

CREATE TABLE `ip_adr_character_quest_log` (
...
CREATE TABLE `ip_adr_character_quest_log_history` (
...
# ADR - Zones by level
ALTER TABLE `ip_adr_zones` ADD `zone_level` INT(8) DEFAULT '0' NOT NULL;

# ADR - Advanced Loot System
ALTER TABLE `ip_adr_shops_items` ADD `item_loottables` TEXT NULL AFTER `item_store_id`;

ALTER TABLE `ip_adr_battle_monsters` ADD `monster_loottables` TEXT NOT NULL AFTER `monster_base_element`;
ALTER TABLE `ip_adr_battle_monsters` ADD `monster_possible_drop` int(8) NOT NULL AFTER `monster_loottables`;
ALTER TABLE `ip_adr_battle_monsters` ADD `monster_guranteened_drop` int(8) NOT NULL AFTER `monster_possible_drop`;
ALTER TABLE `ip_adr_battle_monsters` ADD `monster_specific_drop` TEXT NOT NULL AFTER `monster_guranteened_drop`;

CREATE TABLE `ip_adr_loottables` (
...
# ADR - Brewing
ALTER TABLE `ip_adr_battle_list` ADD `battle_effects` TEXT DEFAULT '' NULL;
ALTER TABLE `ip_adr_battle_pvp` ADD `battle_effects` TEXT DEFAULT '' NULL;
ALTER TABLE `ip_adr_elements` ADD `element_skill_brewing_bonus` INT( 8 ) DEFAULT '0' NOT NULL ;
ALTER TABLE `ip_adr_races` ADD `race_skill_brewing_bonus` INT( 8 ) DEFAULT '0' NOT NULL ;

CREATE TABLE `ip_adr_recipebook` (
...
# ADR - Advanced Spells
CREATE TABLE ip_adr_shops_spells (
...
CREATE TABLE ip_adr_zone_buildings (
...
CREATE TABLE ip_adr_zone_townmaps (
  zonemap_type smallint(2) NOT NULL default '0',
...
ALTER TABLE `ip_adr_stores` ADD `store_zone` TEXT NOT NULL;

# ADR - Items no sell
ALTER TABLE ip_adr_shops_items ADD item_no_sell INT(1) DEFAULT '0' NOT NULL AFTER item_auth;

# ADR - Research
CREATE TABLE `ip_adr_library` (
...
CREATE TABLE `ip_adr_library_learned` (
  `user_id` int(8) NOT NULL,
...
CREATE TABLE `ip_adr_clans_news` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
CREATE TABLE `ip_adr_clans_shouts` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `clan` mediumint(9) NOT NULL default '0',
  `poster` mediumint(9) NOT NULL default '0',
  `text` mediumtext NOT NULL,
