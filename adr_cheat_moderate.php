...
if( isset($_POST['u']) || isset($_GETS['u']) )
{
	$jailed_userid  = ( isset($_POST['u']) ) ? $_POST['u'] : $_GETS['u'];
	$jailed_userid  = intval($jailed_userid);
}
if( isset($_POST['cheat']) || isset($_GETS['cheat']) )
{
	$jailed_cheat_type = ( isset($_POST['cheat']) ) ? $_POST['cheat'] : $_GETS['cheat'];
	$jailed_cheat_type = intval($jailed_cheat_type);
}

if( isset($_POST['cheat_id']) || isset($_GETS['cheat_id']) )
{
	$cheat_id  = ( isset($_POST['cheat_id']) ) ? $_POST['cheat_id'] : $_GETS['cheat_id'];
