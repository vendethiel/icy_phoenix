...
if($mode == 'add')
{
	...
	//Fix item value
	$created_item 	= $_POST['item_created'];
	$first_item 	= $_POST['item1'];
	$second_item 	= $_POST['item2'];
	$third_item 	= $_POST['item3'];
...
else if ( $mode != "" )
{
	switch( $mode )
	{
		case 'delete':
			...
			$pack_id = ( !empty($_POST['id']) ) ? intval($_POST['id']) : intval($_GET['id']);
		...
		case "save":
			...
			$pack_id = ( !empty($_POST['pack_id']) ) ? intval($_POST['pack_id']) : intval($_GET['pack_id']);
			$combine1 = ( isset($_POST['item1']) ) ? trim($_POST['item1']) : trim($_GET['item1']);
			$combine2 = ( isset($_POST['item2']) ) ? trim($_POST['item2']) : trim($_GET['item2']);
			$combine3 = ( isset($_POST['item3']) ) ? trim($_POST['item3']) : trim($_GET['item3']);
			$combine_result = ( isset($_POST['item_created']) ) ? trim($_POST['item_created']) : trim($_GET['item_created']);
