...
if ( $mode != "" )
{
	switch( $mode )
	{
		...
		case 'delete_job':
			...
			$job_id = ( !empty($_POST['job_id']) ) ? intval($_POST['job_id']) : intval($_GET['job_id']);
		...
		case "save_job":
			...
			$item_id = intval($_POST['item_reward_list']);
			$job_name = ( isset($_POST['job_name']) ) ? trim($_POST['job_name']) : trim($_GET['job_name']);
			$job_desc = ( isset($_POST['job_desc']) ) ? trim($_POST['job_desc']) : trim($_GET['job_desc']);
			$job_img = ( isset($_POST['job_img']) ) ? trim($_POST['job_img']) : trim($_GET['job_img']);
			$job_level = intval($_POST['job_level']);
			$job_auth_level = intval($_POST['job_auth_level']);
			$job_race = intval($_POST['race_list']);
			$job_class = intval($_POST['class_list']);
			$job_alignment = intval($_POST['alignment_list']);
			$job_salary = intval($_POST['job_salary']);
			$job_salary_int = intval($_POST['job_salary_int']);
			$job_sp_reward = intval($_POST['job_sp_reward']);
			$job_exp = intval($_POST['job_exp']);
			$job_duration = intval($_POST['job_duration']);
			$job_slots = intval($_POST['job_slots']);
			$job_slots_max = intval($_POST['job_slots_max']);
		...
		case "savenew_job":
			...
			$item_id = intval($_POST['item_reward_item']);
			$job_name = ( isset($_POST['job_name']) ) ? trim($_POST['job_name']) : trim($_GET['job_name']);
			$job_desc = ( isset($_POST['job_desc']) ) ? trim($_POST['job_desc']) : trim($_GET['job_desc']);
			$job_img = ( isset($_POST['job_img']) ) ? trim($_POST['job_img']) : trim($_GET['job_img']);
			$job_level = intval($_POST['job_level']);
