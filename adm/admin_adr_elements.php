...
else if ( $mode != "" )
{
	switch( $mode )
	{
		...
		case "save":
			...
			$b_cooking = intval($_POST['cooking_bonus']);
			$b_brewing = intval($_POST['brewing_bonus']);
			$b_blacksmithing = intval($_POST['blacksmithing_bonus']);
			...
			$b_fishing = intval($_POST['fishing_bonus']);		
			$b_herbalism = intval($_POST['herbalism_bonus']);
			$b_lumberjack = intval($_POST['lumberjack_bonus']);
			$b_hunting = intval($_POST['hunting_bonus']);
			$b_tailoring = intval($_POST['tailoring_bonus']);
			$b_alchemy = intval($_POST['alchemy_bonus']);
