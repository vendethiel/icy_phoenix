...
if ($submit)
{
	$dead_travel = intval($_POST['dead_travel']);
	$stat_bonus = intval($_POST['stat_bonus']);
	$att_bonus = $_POST['att_bonus'];
	$def_bonus = $_POST['def_bonus'];
	$zone_townmap_enable = intval($_POST['Adr_zone_townmap_enable']);
	$zone_townmap_name = $db->sql_escape($_POST['Adr_zone_townmap_name']);
	$zone_picture_link_enable = intval($_POST['Adr_zone_picture_link_enable']);
	$zone_worldmap_zone = intval($_POST['Adr_zone_worldmap_zone']);
	$zone_townmap_display_required = intval($_POST['Adr_zone_townmap_display_required']);

	$zone_npc_display_text = intval($_POST['npc_display_text']);
	$zone_npc_image_link = intval($_POST['npc_image_link']);
	$zone_npc_button_link = intval($_POST['npc_button_link']);
	$npc_display_enable = intval($_POST['npc_display_enable']);
	$zone_npc_image_count = intval($_POST['npc_image_count']);
	$zone_npc_image_size = intval($_POST['npc_image_size']);
	if ( isset( $_POST['zone_cheat_member_pm'] ) )
	{
		$zone_cheat_member_pm = implode(',' , $_POST['zone_cheat_member_pm'] );
	...
	if ( isset( $_POST['zone_adr_moderators'] ) )
	{
		$zone_adr_moderators = implode(',' , $_POST['zone_adr_moderators'] );
	...
	$zone_cheat_auto_ban_adr = intval($_POST['cheat_auto_ban_adr']);
	$zone_cheat_auto_ban_board = intval($_POST['cheat_auto_ban_board']);
	$zone_cheat_auto_jail = intval($_POST['cheat_auto_jail']);
	$zone_cheat_auto_time_day = intval($_POST['cheat_auto_time_day']);
	$zone_cheat_auto_time_hour = intval($_POST['cheat_auto_time_hour']);
	$zone_cheat_auto_time_minute = intval($_POST['cheat_auto_time_minute']);
	$zone_cheat_auto_caution = intval($_POST['cheat_auto_caution']);
	$zone_cheat_auto_freeable = intval($_POST['cheat_auto_freeable']);
	$zone_cheat_auto_cautionable = intval($_POST['cheat_auto_cautionable']);
	$zone_cheat_auto_punishment = intval($_POST['cheat_auto_punishment']);
	$zone_cheat_auto_public = intval($_POST['cheat_auto_public']);
