...
if ( $mode != "" )
{
	switch( $mode )
	{
		...
		case 'delete_loottable':
			...
			$loottable_id = ( !empty($_POST['loottable_id']) ) ? intval($_POST['loottable_id']) : intval($_GET['loottable_id']);
		...
		case "save_loottable":
			...
			$loottable_id = intval($_POST['loottable_id']);
			$loottable_name = ( isset($_POST['loottable_name']) ) ? trim($_POST['loottable_name']) : trim($_GET['loottable_name']);
			$loottable_desc = ( isset($_POST['loottable_desc']) ) ? trim($_POST['loottable_desc']) : trim($_GET['loottable_desc']);
			$loottable_dropchance = intval($_POST['loottable_dropchance']);
			$loottable_status = intval($_POST['loottable_status']);
