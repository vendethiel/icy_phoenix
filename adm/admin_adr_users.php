...
{	
	switch($mode)
	{
		...
		case 'validate' :
			...
			$shield_level = intval($_POST['character_skill_shield_level']);
			// spell
			$defmagic_level = intval($_POST['character_skill_defmagic_level']);
			$defmagic_uses = intval($_POST['character_skill_defmagic_uses']);
			$offmagic_level = intval($_POST['character_skill_offmagic_level']);	
			$offmagic_uses = intval($_POST['character_skill_offmagic_uses']);
			...
			$shield_uses = intval($_POST['character_skill_shield_uses']);
